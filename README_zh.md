...
#2 geometry.find_insertion_candidates: Dry run ... -> skipped
```
...
#2 geometry.find_insertion_candidates: Found 5 insertion candidate(s). -> pass
```
...
geometry.find_insertion_candidates
